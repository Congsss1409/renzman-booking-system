        ...
        <?php $__empty_1 = true; $__currentLoopData = $payrolls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="bg-white rounded-2xl shadow-lg p-6 flex flex-col items-center text-center min-w-0">
                ...
                <div class="mt-4 flex flex-col gap-2 w-full">
                    ...
                    <form action="<?php echo e(route('admin.payrolls.destroy', $p->id)); ?>" method="POST" class="w-full" onsubmit="return confirm('Are you sure you want to delete this payroll? This action cannot be undone.');">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Desktop\renzman-booking-system\resources\views/payrolls/index.blade.php ENDPATH**/ ?>