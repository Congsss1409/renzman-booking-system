...
<div class="relative min-h-screen w-full text-black bg-cover bg-center bg-no-repeat" style="background-image: url('<?php echo e(asset('images/store4.jpg')); ?>');">
...
</html><?php /**PATH C:\xampp\htdocs\renzman-booking-system\resources\views/layouts/Booking.blade.php ENDPATH**/ ?>