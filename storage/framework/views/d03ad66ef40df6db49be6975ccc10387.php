...
<div class="glass-panel rounded-3xl max-w-6xl mx-auto overflow-hidden shadow-2xl">
    ...
    <div class="p-8 md:p-12 flex flex-col h-full" x-data="dateTimePicker('<?php echo e($now); ?>', <?php echo e(json_encode($todayForJs)); ?>, <?php echo e($extendedSession ? 'true' : 'false'); ?>)">
            <div class="mb-8">
                <div class="flex justify-between items-center text-sm font-semibold text-cyan-100 mb-2"><span class="text-black">Step 3/5: Date & Time</span><span class="text-black">60%</span></div>
...
<?php echo $__env->make('layouts.Booking', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Vincen Basa\Desktop\renzman-booking-system\resources\views/booking/step-three.blade.php ENDPATH**/ ?>