...
<body class="bg-gray-100">
    ...
    <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-100">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 w-64 flex-shrink-0 bg-gradient-to-b from-teal-600 to-cyan-700 text-teal-100 flex flex-col transform transition-transform duration-300 ease-in-out z-30 lg:relative lg:translate-x-0">
            ...
            <nav class="flex-grow px-4">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="sidebar-link flex items-center gap-4 px-4 py-3 rounded-lg transition-colors hover:bg-teal-700 <?php if(request()->routeIs('admin.dashboard')): ?> active <?php endif; ?>">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                    <span>Dashboard</span>
                </a>
                <a href="<?php echo e(route('admin.therapists.index')); ?>" class="sidebar-link flex items-center gap-4 px-4 py-3 rounded-lg transition-colors hover:bg-teal-700 <?php if(request()->routeIs('admin.therapists.*')): ?> active <?php endif; ?>">
                ...
                <a href="<?php echo e(route('admin.services.index')); ?>" class="sidebar-link flex items-center gap-4 px-4 py-3 rounded-lg transition-colors hover:bg-teal-700 <?php if(request()->routeIs('admin.services.*')): ?> active <?php endif; ?>">
                    <svg class="w-6 h-6 text-teal-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
                    <span>Services</span>
                </a>
                <a href="<?php echo e(route('admin.payrolls.index')); ?>" class="sidebar-link flex items-center gap-4 px-4 py-3 rounded-lg transition-colors hover:bg-teal-700 <?php if(request()->routeIs('admin.payrolls.*')): ?> active <?php endif; ?>">
                ...
                <a href="<?php echo e(route('admin.feedback')); ?>" class="sidebar-link flex items-center gap-4 px-4 py-3 rounded-lg transition-colors hover:bg-teal-700 <?php if(request()->routeIs('admin.feedback')): ?> active <?php endif; ?>">
                ...
                <a href="<?php echo e(route('admin.users.index')); ?>" class="sidebar-link flex items-center gap-4 px-4 py-3 rounded-lg transition-colors hover:bg-teal-700 <?php if(request()->routeIs('admin.users.*')): ?> active <?php endif; ?>">
                ...
                <?php endif; ?>
                <!-- New Branches link -->
                <a href="<?php echo e(route('admin.branches.index')); ?>" class="sidebar-link flex items-center gap-4 px-4 py-3 rounded-lg transition-colors hover:bg-teal-700 <?php if(request()->routeIs('admin.branches.*')): ?> active <?php endif; ?>">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            <?php endif; ?>
            <?php if($errors->bookingCreation->any()): ?>
                 Swal.fire({ icon: 'error', title: 'Oops...', html: `<p class="mb-2">There were some problems with your input:</p><ul class="text-left list-disc list-inside"><?php $__currentLoopData = $errors->bookingCreation->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><li><?php echo e($error); ?></li><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></ul>` });
            <?php endif; ?>
...
<?php /**PATH C:\Users\Vincen Basa\Desktop\renzman-booking-system\resources\views/layouts/admin.blade.php ENDPATH**/ ?>