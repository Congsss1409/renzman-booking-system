...
<body>
    <div class="wrapper">
        <div class="card">
            ...
            <div class="card-body">
                <p>Hi <?php echo e($booking->client_name); ?>,</p>
                <p>Thank you for choosing Renzman Spa! We hope you enjoyed your recent <?php echo e($booking->service->name ?? 'spa service'); ?> with <?php echo e($booking->therapist->name ?? 'our therapist'); ?>.</p>
                <div class="booking-info">
                    ...
                    <p><strong>Date:</strong> <?php echo e($booking->start_time ? $booking->start_time->format('F d, Y \a\t h:i A') : 'N/A'); ?></p>
                    <p><strong>Location:</strong> <?php echo e($booking->branch->name ?? 'N/A'); ?></p>
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\renzman-booking-system\resources\views/emails/feedback-request.blade.php ENDPATH**/ ?>