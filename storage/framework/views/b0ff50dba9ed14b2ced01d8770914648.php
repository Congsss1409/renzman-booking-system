    ...
    <div class="wrapper">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ul class="info-list">
                    <li><span class="info-label">Service</span><?php echo e($booking->service->name ?? 'N/A'); ?></li>
                    <li><span class="info-label">Therapist</span><?php echo e($booking->therapist->name ?? 'N/A'); ?></li>
                    <li><span class="info-label">Branch</span><?php echo e($booking->branch->name ?? 'N/A'); ?></li>
                    <li><span class="info-label">Date &amp; Time</span><?php echo e(optional($booking->start_time)->format('F d, Y \a\t h:i A')); ?></li>
                </ul>
...
<?php /**PATH C:\xampp\htdocs\renzman-booking-system\resources\views/emails/booking-cancelled.blade.php ENDPATH**/ ?>