...
<div class="p-4 sm:p-6 lg:p-8">
    ...
    <div class="grid grid-cols-1 gap-6 mt-8 sm:grid-cols-2 lg:grid-cols-3">
        <div class="p-6 bg-white border border-gray-200 rounded-xl">
            ...
            <p class="mt-2 text-3xl font-bold text-gray-900">₱<?php echo e(number_format($totalRevenue, 2)); ?></p>
        </div>
        <div class="p-6 bg-white border border-gray-200 rounded-xl">
            <p class="text-sm font-medium text-gray-500">Total Bookings</p>
            <p class="mt-2 text-3xl font-bold text-gray-900"><?php echo e($totalBookings); ?></p>
        </div>
        <div class="p-6 bg-white border border-gray-200 rounded-xl">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    new Chart(bookingsByMonthCtx, {
        type: 'bar',
        data: {
            labels: <?php echo json_encode($bookingsByMonthLabels, 15, 512) ?>,
            datasets: [{
                label: 'Bookings',
                data: <?php echo json_encode($bookingsByMonthData, 15, 512) ?>,
    ...
    new Chart(popularServicesCtx, {
        type: 'doughnut',
        data: {
            labels: <?php echo json_encode($popularServicesLabels, 15, 512) ?>,
            datasets: [{
                data: <?php echo json_encode($popularServicesData, 15, 512) ?>,
    ...
    new Chart(busiestTherapistsCtx, {
        type: 'pie',
        data: {
            labels: <?php echo json_encode($busiestTherapistsLabels, 15, 512) ?>,
            datasets: [{
                data: <?php echo json_encode($busiestTherapistsData, 15, 512) ?>,
                backgroundColor: ['#4f46e5', '#6366f1', '#818cf8', '#a5b4fc', '#c7d2fe'],
                hoverOffset: 4
            }]
        },
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\renzman-booking-system\resources\views\admin\analytics.blade.php ENDPATH**/ ?>