...
<body>
  ...
  <div class="content">
  <div class="container">
  <p class="greeting">Hi <?php echo e($b->client_name); ?>,</p>
  ...
  <p><strong>Service:</strong> <?php echo e($b->service->name ?? 'N/A'); ?></p>
  <p><strong>Therapist:</strong> <?php echo e($b->therapist->name ?? 'N/A'); ?></p>
  <p><strong>Date &amp; Time:</strong> <?php echo e(optional($b->start_time)->format('F d, Y \a\t h:i A')); ?></p>
  <p><strong>Branch:</strong> <?php echo e($b->branch->name ?? 'N/A'); ?></p>
  <p><strong>Price:</strong> ₱<?php echo e(number_format($b->price ?? 0, 2)); ?></p>
  </div>
  ...
  <div class="footer">&copy; <?php echo e(date('Y')); ?> Renzman. All rights reserved.</div>
</body>
</html>
<?php $b = $booking; ?>
...
<body>
  <div class="wrapper">
    <div class="card">
      ...
      <p class="details">Hi <?php echo e($b->client_name); ?>,</p>
      <p class="details">Your booking has been confirmed. Here are the details:</p>
      ...
      <?php if(!empty($feedbackUrl)): ?>
        <div style="text-align:center; margin:18px 0;">
          <a href="<?php echo e($feedbackUrl); ?>" class="btn">Share Your Feedback</a>
        </div>
      <?php endif; ?>

      <div class="footer">
        &copy; <?php echo e(date('Y')); ?> Renzman. All rights reserved.
      </div>
    </div>
  </div>
</body>
