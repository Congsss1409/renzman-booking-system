...
<div class="glass-panel rounded-3xl max-w-6xl mx-auto overflow-hidden shadow-2xl">
    <div class="grid md:grid-cols-2">
        ...
        <div class="p-8 md:p-12">
            ...
            <form x-data="{ showPrivacyModal: false, agreed: false }" x-ref="bookingForm" action="<?php echo e(route('booking.store.step-four')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.Booking', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Vincen Basa\Desktop\renzman-booking-system\resources\views/booking/step-four.blade.php ENDPATH**/ ?>