...
<div class="space-y-6 sm:space-y-8">
    ...
    <div class="bg-gradient-to-br from-teal-400 to-cyan-600 text-white p-4 sm:p-6 rounded-2xl shadow-xl transform hover:-translate-y-1 transition-all duration-300">
            ...
            <p class="mt-4 text-4xl sm:text-5xl 2xl:text-6xl font-bold"><?php echo e($todaysBookings); ?></p>
        </div>
    <div class="bg-gradient-to-br from-teal-400 to-cyan-600 text-white p-4 sm:p-6 rounded-2xl shadow-xl transform hover:-translate-y-1 transition-all duration-300">
            ...
            <p class="mt-4 text-4xl sm:text-5xl 2xl:text-6xl font-bold"><?php echo e($totalBookings); ?></p>
        </div>
        <div 
            ...
            <div class="mt-4 flex flex-nowrap items-baseline gap-1 font-bold text-2xl sm:text-3xl lg:text-4xl 2xl:text-5xl">
                ...
                <span class="tracking-tight leading-tight"><?php echo e(number_format($totalRevenue, 2)); ?></span>
            </div>
    ...
    <div class="bg-gradient-to-br from-teal-400 to-cyan-600 text-white p-4 sm:p-6 rounded-2xl shadow-xl transform hover:-translate-y-1 transition-all duration-300">
            ...
            <p class="mt-4 text-3xl sm:text-4xl 2xl:text-5xl font-bold"><?php echo e(number_format($averageRating, 2)); ?> <span class="text-yellow-300">★</span></p>
        </div>
    <div class="bg-gradient-to-br from-green-200 to-green-400 text-green-900 p-4 sm:p-6 rounded-2xl shadow-xl transform hover:-translate-y-1 transition-all duration-300">
            ...
            <p class="mt-4 text-3xl sm:text-4xl 2xl:text-5xl font-bold"><?php echo e($totalCompleted); ?></p>
        </div>
    <div class="bg-gradient-to-br from-red-200 to-red-400 text-red-900 p-4 sm:p-6 rounded-2xl shadow-xl transform hover:-translate-y-1 transition-all duration-300">
            ...
            <p class="mt-4 text-3xl sm:text-4xl 2xl:text-5xl font-bold"><?php echo e($totalCancellations); ?></p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 items-start">
        ...
        <div class="lg:col-span-2 bg-white p-4 sm:p-6 rounded-2xl shadow-lg">
            <div class="flex flex-col sm:flex-row justify-between items-stretch sm:items-center mb-4 gap-4">
                ...
                <form action="<?php echo e(route('admin.dashboard')); ?>" method="GET" class="flex w-full sm:w-auto items-stretch gap-2 sm:gap-0">
                    <input type="text" name="search" placeholder="Search bookings..." value="<?php echo e(request('search')); ?>" class="w-full sm:w-64 p-2 border border-gray-300 rounded-lg sm:rounded-l-lg sm:rounded-r-none focus:outline-none focus:ring-2 focus:ring-teal-500">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (topServicesCtx) {
        new Chart(topServicesCtx, {
            type: 'doughnut',
            data: {
                labels: <?php echo json_encode($topServicesLabels, 15, 512) ?>,
                datasets: [{
                    label: 'Bookings',
                    data: <?php echo json_encode($topServicesData, 15, 512) ?>,
    ...
    if ('EventSource' in window) {
        const sseUrl = '<?php echo e(route('admin.dashboard.events')); ?>';
        let source = null;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\renzman-booking-system\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>