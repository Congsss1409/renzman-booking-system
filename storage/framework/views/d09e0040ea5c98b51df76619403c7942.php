    ...
    <div class="p-4 sm:p-6 md:p-12 w-full">
            ...
            <form x-ref="stepTwoForm" action="<?php echo e(route('booking.store.step-two')); ?>" method="POST">
                ...
                <div class="mt-10 flex justify-between">
                    <a href="<?php echo e(route('booking.create.step-one')); ?>" class="bg-white/40 text-teal-700 font-bold py-3 px-10 rounded-full border border-teal-200 shadow hover:bg-white/60 transition-all transform hover:scale-105">
                        &larr; Back
                    </a>
