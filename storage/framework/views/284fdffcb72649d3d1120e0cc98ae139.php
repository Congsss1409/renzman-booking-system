...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
            ...
            <div x-data="{ imagePreview: '<?php echo e($therapist->image_url); ?>' }" class="flex items-center gap-4">
                <img :src="imagePreview" alt="Current or new image preview" class="w-20 h-20 rounded-full object-cover border-2 border-gray-300">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\renzman-booking-system\resources\views\admin\therapist\edit.blade.php ENDPATH**/ ?>