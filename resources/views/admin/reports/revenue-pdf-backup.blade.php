    ...
    <div class="container">
            ...
            <div class="summary-section">
                <div class="summary-cards">
                    ...
                    <div class="summary-card blue-card">
                        ...
                        <div class="card-value">₱{{ number_format($totalRevenue, 2) }}</div>
                        <div class="card-subtitle">{{ $monthName }} {{ $year }}</div>
                    </div>
                    <div class="summary-card green-card">
                        <div class="card-title">Average per Booking</div>
                        <div class="card-value">₱{{ $bookings->count() > 0 ? number_format($totalRevenue / $bookings->count(), 2) : '0.00' }}</div>
                        ...
                        @forelse($bookings as $booking)
                            <tr>
                                <td class="date-column">
                                    ...
                                    <small style="color: #a0aec0;">{{ $booking->start_time->format('h:i A') }}</small>
                                </td>
                                <td class="client-column">{{ $booking->client_name }}</td>
                                <td class="therapist-column">{{ optional($booking->therapist)->name ?? 'Unassigned' }}</td>
        ...
        <div class="footer">
            ...
            <div class="generation-date">
                Generated on {{ now()->format('F d, Y \a\t h:i A') }} | {{ $bookings->count() }} records processed
            </div>
        </div>
    </div>
</body>
