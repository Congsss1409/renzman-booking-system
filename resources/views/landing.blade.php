...
<div class="bg-white">
    <div class="relative">
        <div class="absolute inset-0">
            <img class="w-full h-full object-cover" src="https://images.unsplash.com/photo-1544161515-cfd8161dc5e9?q=80&w=1974&auto=format&fit=crop" alt="Relaxing massage environment">
    ...
    <section class="py-16 sm:py-20">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                {{-- Card 1: Bed Massage --}}
                <div class="group relative block bg-black rounded-2xl shadow-lg overflow-hidden">
                    <img alt="Bed Massage Room" src="https://images.unsplash.com/photo-1512290923902-8a9fde1be8b7?q=80&w=1974&auto=format&fit=crop" class="absolute inset-0 h-full w-full object-cover opacity-75 transition-opacity group-hover:opacity-50" />
                ...
                {{-- Card 2: Chair Massage --}}
                <div class="group relative block bg-black rounded-2xl shadow-lg overflow-hidden">
                    <img alt="Chair Massage Area" src="https://images.unsplash.com/photo-1620734374323-e3229c8b1a37?q=80&w=1974&auto=format&fit=crop" class="absolute inset-0 h-full w-full object-cover opacity-75 transition-opacity group-hover:opacity-50" />
                    <div class="relative p-8">
                ...
                {{-- Card 3: Specialized Treatments --}}
                <div class="group relative block bg-black rounded-2xl shadow-lg overflow-hidden">
                    <img alt="Specialized Treatment Room" src="https://images.unsplash.com/photo-1599544941429-68b3c3c72b15?q=80&w=1974&auto=format&fit=crop" class="absolute inset-0 h-full w-full object-cover opacity-75 transition-opacity group-hover:opacity-50" />
                    <div class="relative p-8">
