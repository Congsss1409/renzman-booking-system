...
<div class="glass-panel rounded-3xl max-w-4xl mx-auto p-8 md:p-12 shadow-2xl text-center">
    ...
    <div class="mt-8">
        ...
        <p class="mt-4 text-lg text-black">Thank you, {{ $booking->client_name }}. Your appointment is scheduled.</p>
        <p class="mt-2 text-black">A confirmation email with your booking details has been sent to {{ $booking->client_email }}.</p>
    </div>
