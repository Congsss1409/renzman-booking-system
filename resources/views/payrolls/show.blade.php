...
<div class="space-y-6">
    <div>
        <h1 class="text-2xl font-bold">Payroll #{{ $payroll->id }}</h1>
    ...
    <div class="bg-white rounded-2xl shadow p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-1">
            ...
            <div class="mt-4">
                <a href="{{ route('admin.payrolls.export_pdf', $payroll->id) }}" class="inline-flex items-center gap-2 bg-cyan-400 text-white py-2 px-4 rounded-full shadow-md hover:bg-cyan-500">
    ...
    <div>
        <a href="{{ route('admin.payrolls.index') }}" class="text-gray-600">&larr; Back to payrolls</a>
    </div>
</div>
@endsection
